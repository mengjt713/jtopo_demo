    ...
    function b(c) {
        this.initialize = function (c) {
            ...
            if (null != b && "" != b) {
                ...
                var c = a.measureText(b).width, d = a.measureText("�?").width;
    ...
    function f(b, c, g) {
        ...
        this.paintText = function (a, b) {
            ...
            if (4 == b.length && (c = b[1], d = b[2]), this.text && this.text.length > 0) {
                ...
                var g = a.measureText(this.text).width, h = a.measureText("�?").width;
    ...
    function g(a, b, c) {
        this.initialize = function () {
            ...
            if (this.text && this.text.length > 0) {
                ...
                a.save(), a.beginPath(), a.font = this.font;
                var f = a.measureText(this.text).width, g = a.measureText("�?").width;
    ...
    function b() {
        ...
        return b.radius = 150, b.colors = ["#3666B0", "#2CA8E0", "#77D1F6"], b.datas = [.3, .3, .4], b.titles = ["A", "B", "C"], b.paint = function (a) {
            ...
            for (var e = 0, f = 0; f < this.datas.length; f++) {
                ...
                var h = this.titles[f] + ": " + (100 * this.datas[f]).toFixed(2) + "%", i = a.measureText(h).width, j = (a.measureText("�?").width, (e + e + g) / 2), k = this.radius * Math.cos(j), l = this.radius * Math.sin(j);
    ...
    function c() {
        ...
        return b.showSelected = !1, b.width = 250, b.height = 180, b.colors = ["#3666B0", "#2CA8E0", "#77D1F6"], b.datas = [.3, .3, .4], b.titles = ["A", "B", "C"], b.paint = function (a) {
            ...
            for (var e = 0; e < this.datas.length; e++) {
                ...
                a.fillRect(g, h, d, f);
                var i = "" + parseInt(this.datas[e]), j = a.measureText(i).width, k = a.measureText("�?").width;
